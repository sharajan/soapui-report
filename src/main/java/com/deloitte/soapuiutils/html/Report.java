package com.deloitte.soapuiutils.html;
...
public class Report {
	...
	public Report(String reportPath, String reportName) {
		try {
			...
			SoapUI.log("Path of report" + path);
			...
			reports.setSystemInfo("<b>Plugin Owner / Maintainer</b>",
					"<b>Sharon Rajan | <a href='mailto:sharajan@deloitte.com'><b>sharajan@deloitte.com</b></a></b>");
